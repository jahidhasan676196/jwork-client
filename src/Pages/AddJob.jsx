...
const AddJob = () => {
    ...
    const handleAddJobs=(e)=>{
        ...
        const Info={
            job_title,category, date,min_price,max_price,description,buyer_email
        }
        console.log(Info);
          ...
          <form onSubmit={handleAddJobs}>
            <div className='grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2'>
              ...
              <div className='flex flex-col gap-2 '>
                ...
                <DatePicker className="border py-2 px-5 rounded-md" selected={startDate} onChange={(date) => setStartDate(date)} />
              </div>
