...
const MyPostedJobs = () => {
    ...
    const handledeleteElements=(id)=>{
      fetch(`http://localhost:5000/jobsDelete/${id}`,{
        method:'DELETE'
      })
      .then(res=>res.json())
      .then(data=>{
          ...
          <div className='inline-block min-w-full py-2 align-middle md:px-6 lg:px-8'>
            <div className='overflow-hidden border border-gray-200  md:rounded-lg'>
              <table className='min-w-full divide-y divide-gray-200'>
                ...
                {
                  postedJobs.map(job=>      <tbody className='bg-white divide-y divide-gray-200 '>
                    <tr>
                      ...
                      <td className='px-4 py-4 text-sm whitespace-nowrap'>
                        <div className='flex items-center gap-x-6'>
                          <button onClick={()=>handledeleteElements(job?._id)} className='text-gray-500 transition-colors duration-200   hover:text-red-500 focus:outline-none'>
                            <svg
